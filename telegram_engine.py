...
def run_forward_test():
    print("=== STARTING MACRO ENGINE EVALUATION ===")
    ...
    low_prev = float(safe_iloc(gold_1h['Low'], -2, close - 5.0))
    high_prev = float(safe_iloc(gold_1h['High'], -2, close + 5.0))

    risk_amount = 100.0  # 1% Risk on $10,000 baseline

    # Terminal Log Output
    print(f"Macro Bias Score: {score}/8")
